...
function ReviewPage() {
  ...
  return (
     <div className='flex items-center justify-center flex-col'>
      ...
      <span className='lg:w-[50%] md:w-[80%] text-[15px] text-center mt-[30px] mb-[30px] px-[20px]'>Discover how our Smart Courses is transforming learning experiences through real feedback from students and professionals worldwide.</span>
